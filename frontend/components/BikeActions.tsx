  ...
  <div className="mt-8 space-y-6">
    <div className="rounded-2xl border border-white/10 bg-white/5 p-5">
      ...
      {deliveryMethod === "pickup" && (
        <div className="mt-5 rounded-xl border border-blue-500/30 bg-blue-500/10 p-4 text-sm text-blue-100">
          <p className="font-semibold text-white">Local Pickup selected</p>
          <p className="mt-1">
