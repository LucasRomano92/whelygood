...
export default async function ShopBikeDetailPage({
  params,
}: {
    ...
    <main className="min-h-screen bg-black px-6 py-16 text-white md:px-10">
      <div className="mx-auto grid max-w-6xl gap-10 md:grid-cols-2">
        ...
        <div>
          ...
          <p className="mt-4 text-2xl font-semibold">${bike.price}</p>
          ...
          <BikeActions bikeId={bike._id} category="shop" />
